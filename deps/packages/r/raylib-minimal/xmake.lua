package("raylib-minimal")
-- It's copied from https://github.com/xmake-io/xmake-repo/blob/master/packages/r/raylib/xmake.lua
-- But re-configured to build a portable executable.
    ...
    on_install("windows", "linux", "macosx|arm64", "mingw", function (package)
        ...
        import("package.tools.cmake").install(package, configs, {packagedeps = { "libglvnd" }})
    end)
